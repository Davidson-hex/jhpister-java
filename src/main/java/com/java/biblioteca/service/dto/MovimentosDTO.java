...
/**
 * A DTO for the {@link com.java.biblioteca.domain.Movimentos} entity.
 */
public class MovimentosDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MovimentosDTO)) {
            return false;
        }

        MovimentosDTO movimentosDTO = (MovimentosDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, movimentosDTO.id);
    }
